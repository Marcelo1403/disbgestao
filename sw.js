const CACHE='disb-gestao-v1.6.3-ativo-layout';
const STATIC=['./','index.html','styles.css?v=1.6.3-ativo-layout','app.js?v=1.6.3-ativo-layout','config.js?v=1.6.3','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
