const CACHE='disb-gestao-v1.6.1-user-units';
const STATIC=['./','index.html','styles.css?v=1.6.1-user-units','app.js?v=1.6.1-user-units','config.js?v=1.6.1','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
