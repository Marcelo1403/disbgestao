const CACHE='disb-gestao-v1.5.1-fefo-sem-lote';
const STATIC=['./','index.html','styles.css?v=1.5.1-launch-bulk','app.js?v=1.5.1-fefo-sem-lote','config.js?v=1.5.1','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
