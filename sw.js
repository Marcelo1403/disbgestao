const CACHE='disb-gestao-v1.3.0-contagem-fefo';
const STATIC=['./','index.html','styles.css?v=1.3.0','app.js?v=1.3.0','config.js?v=1.3.0','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
