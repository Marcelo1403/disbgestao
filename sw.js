const CACHE='disb-gestao-v1.1.7-cache-nativo';
const STATIC=['./','index.html','styles.css?v=1.1.7','app.js?v=1.1.7','config.js?v=1.1.7','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
