const CACHE='disb-gestao-v1.4.1-nri-fefo-product-multilot';
const STATIC=['./','index.html','styles.css?v=1.4.1','app.js?v=1.4.1','config.js?v=1.4.1','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
