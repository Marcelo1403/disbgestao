const CACHE='disb-gestao-v1.2.2-dashboard-avarias';
const STATIC=['./','index.html','styles.css?v=1.2.2','app.js?v=1.2.2','config.js?v=1.2.2','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
