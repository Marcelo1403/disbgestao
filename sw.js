const CACHE='disb-gestao-v1.1.6-cache-nativo';
const STATIC=['./','index.html','styles.css?v=1.1.6','app.js?v=1.1.6','config.js?v=1.1.6','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
