const CACHE='disb-gestao-v1.6.2-operacional';
const STATIC=['./','index.html','styles.css?v=1.6.2-operacional','app.js?v=1.6.2-operacional','config.js?v=1.6.2','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
