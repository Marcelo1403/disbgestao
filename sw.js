const CACHE='disb-gestao-v1.6.6-avarias-vendas';
const STATIC=['./','index.html','styles.css?v=1.6.6-avarias-vendas','app.js?v=1.6.6-avarias-vendas','config.js?v=1.6.6','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
