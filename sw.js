const CACHE='disb-gestao-v1.2.1-evidencias-marketplace';
const STATIC=['./','index.html','styles.css?v=1.2.1','app.js?v=1.2.1','config.js?v=1.2.1','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
