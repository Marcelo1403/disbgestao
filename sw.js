const CACHE='disb-gestao-v1.1.4-gps-dashboard-etapas';
const STATIC=['./','index.html','styles.css','app.js','config.js','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
