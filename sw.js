const CACHE='disb-gestao-v1.5.1-avarias-vendas-fluxo-final-camera-gps';
const STATIC=['./','index.html','styles.css?v=1.5.1','app.js?v=1.5.1','config.js?v=1.5.1','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
