const CACHE='disb-gestao-v1.6.0-offline-unidades';
const STATIC=['./','index.html','styles.css?v=1.6.0-offline-unidades','app.js?v=1.6.0-offline-unidades','config.js?v=1.6.0','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
