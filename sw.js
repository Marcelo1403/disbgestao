const CACHE='disb-gestao-v1.1.9-ocorrencia-lock';
const STATIC=['./','index.html','styles.css?v=1.1.9','app.js?v=1.1.9','config.js?v=1.1.9','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png'];
